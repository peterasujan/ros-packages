...
if("TRUE" STREQUAL "TRUE")
  set(pcl_conversions_SOURCE_PREFIX /home/peter/groovy_workspace/src/pcl_conversions)
  set(pcl_conversions_DEVEL_PREFIX /home/peter/groovy_workspace/devel)
  ...
  set(pcl_conversions_INSTALL_PREFIX /home/peter/groovy_workspace/install)
...
if(NOT "/home/peter/groovy_workspace/src/pcl_conversions/include;/usr/include/eigen3;/usr/include;/opt/ros/groovy/include/pcl-1.6" STREQUAL "")
  set(pcl_conversions_INCLUDE_DIRS "")
  set(_include_dirs "/home/peter/groovy_workspace/src/pcl_conversions/include;/usr/include/eigen3;/usr/include;/opt/ros/groovy/include/pcl-1.6")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'pcl_conversions' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'William Woodall <william@osrfoundation.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'pcl_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/peter/groovy_workspace/src/pcl_conversions/${idir}'.  Ask the maintainer 'William Woodall <william@osrfoundation.org>' to fix it.")
    endif()
